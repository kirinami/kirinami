...
import { TODOS_CREATE_MUTATION, TodosCreateInput, TodosCreateMutation } from '@/apollo/todos/mutations/todos/todosCreate';
import { TODOS_UPDATE_MUTATION, TodosUpdateInput, TodosUpdateMutation } from '@/apollo/todos/mutations/todos/todosUpdate';
import { TODOS_DELETE_MUTATION, TodosDeleteInput, TodosDeleteMutation } from '@/apollo/todos/mutations/todos/todosDelete';
import { TODOS_ALL_QUERY, TodosAllQuery } from '@/apollo/todos/queries/todos/todosAll';
